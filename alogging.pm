...
# ... [ see sjdUtils.pm ]
# 2018-03-27 Split to separate package.
# 2018-09-25: Get rid of remaining sjdUtils dependencies.
#
# To do:
...
Provide some very basic useful utilities for handling error messages.
...
There is also a handle C<pline()> call for printing nicely-aligned columns

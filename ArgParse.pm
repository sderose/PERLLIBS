...
our %metadata = (
    'title'        => "ArgParse.pm",
    'description'  => "Perl version of the Python 'argparse' package.",
...
A more structured interface to C<Getopt::Long>.
Very like Python's C<argparse> library.

The package works by accepting a Python C<argparse>-like API, and assembling
appropriate calls to Perl C<Getopt::Long> to accomplish the same thing.

What would be I<named arguments> in Python, are passed using a hash.

See L<http://docs.python.org/dev/library/argparse.html>.

You get I<-h/--help> and I<--version> for free.
...
=head1 History
  ...
  2021-11-11: New layout. This isn't really maintained, I don't use Perl much any more.
